...
const Header = ({ setAuthUser, sidebarOpen, setSidebarOpen }) => {
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center lg:justify-end justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className="flex items-center gap-3 2xsm:gap-7">
          ...
          <DropdownUser setAuthUser={setAuthUser} />
        </div>
      </div>
    </header>
  );
